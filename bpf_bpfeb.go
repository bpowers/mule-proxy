...
type bpfMapSpecs struct {
	BackendConns  *ebpf.MapSpec `ebpf:"backend_conns"`
	FrontendConns *ebpf.MapSpec `ebpf:"frontend_conns"`
}
...
// It can be passed to loadBpfObjects or ebpf.CollectionSpec.LoadAndAssign.
type bpfMaps struct {
	BackendConns  *ebpf.Map `ebpf:"backend_conns"`
	FrontendConns *ebpf.Map `ebpf:"frontend_conns"`
}
